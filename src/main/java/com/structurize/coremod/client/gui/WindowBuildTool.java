...
import com.structurize.coremod.repomanagement.repostructure.Trinuple;
...
public class WindowBuildTool extends AbstractWindowSkeleton
{
     ...
     * Drop down list for style.
     */
    private DropDownList headsDropDownList;

    /**
     * Drop down list for style.
     */
    private DropDownList typesDropDownList;
    ...
    /**
     * Dialog for managing styles.
     */
    private WindowManageStyles windowManageStyles;
    ...
    // TODO PROBABLY NEEDS REGET WHEN SCANS THINGS HAVE BEEN CHANGED
    ...
    private void init(final BlockPos pos)
    {
        ...
        registerButton(BUTTON_MANAGE_STYLES, this::manageStylesClicked);
    ...
    private void initStylesNavigation()
    {
        ...
        registerButton(BUTTON_NEXT_STYLE_ID, () -> {
            stylesDropDownList.selectNext();
        });
        registerButton(BUTTON_PREVIOUS_HEAD_ID, () -> {
            headsDropDownList.selectPrevious();
        });
        registerButton(BUTTON_NEXT_HEAD_ID, () -> {
            headsDropDownList.selectNext();
        });
        registerButton(BUTTON_PREVIOUS_TYPE_ID, () -> {
            typesDropDownList.selectPrevious();
        });
        registerButton(BUTTON_NEXT_TYPE_ID, () -> {
            typesDropDownList.selectNext();
        });
        registerButton(BUTTON_PREVIOUS_FILE_ID, () -> {
            filesDropDownList.selectPrevious();
        });
        registerButton(BUTTON_NEXT_FILE_ID, () -> {
            filesDropDownList.selectNext();
        });
        ...
        filesDropDownList.setSelectedIndex(0);
    }
    ...
    public void onClosed()
    {
        ...
        {
            Settings.instance.setSchematicInfo(getPickedSchematicAsPath(), rotation);
        }
    }
