...
public class Structurize {
    ...
    /**
     * Access to the proxy associated with your current side. Variable updated by
     * forge.
     */
    ...
    private static synchronized void initializeNetwork() {
        ...
        getNetwork().registerMessage(UpdateScanToolMessage.class, UpdateScanToolMessage.class, ++id, Side.SERVER);
        ...
        // Link session
        getNetwork().registerMessage(LSStructureDisplayerMessage.class, LSStructureDisplayerMessage.class, ++id,
                Side.SERVER);
        getNetwork().registerMessage(LSStructureDisplayerMessage.class, LSStructureDisplayerMessage.class, ++id,
                Side.CLIENT);
