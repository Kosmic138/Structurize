...
public class Type {
     ...
     * Creates new type
     */
    public Type(final String id, final String name, final String origin) {
        this.id = id;
        this.name = name;
        this.origin = origin;
    }
    ...
    /**
     * Returns Trinuple<String, String, String> with file id, name and origin if
     * found, else null
     */
    ...
    public String getFilePathById(final String fileId) {
        final Trinuple<String, String, String> file = files.stream()
                .filter(fileCheck -> fileCheck.getFirst().equals(fileId)).findFirst().orElse(null);
