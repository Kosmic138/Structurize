...
public class TemplateTessellator
{
    ...
    public void draw()
    {
        ...
        this.buffer.drawArrays(GL11.GL_QUADS);
    ...
    private static void preTemplateDraw()
    {
        ...
        GlStateManager.glVertexPointer(VERTEX_COMPONENT_SIZE, GL11.GL_FLOAT, VERTEX_SIZE, VERTEX_COMPONENT_OFFSET);
        GlStateManager.glColorPointer(COLOR_COMPONENT_SIZE, GL11.GL_UNSIGNED_BYTE, VERTEX_SIZE, COLOR_COMPONENT_OFFSET);
        GlStateManager.glTexCoordPointer(TEX_COORD_COMPONENT_SIZE, GL11.GL_FLOAT, VERTEX_SIZE, TEX_COORD_COMPONENT_OFFSET);
        OpenGlHelper.setClientActiveTexture(OpenGlHelper.lightmapTexUnit);
        GlStateManager.glTexCoordPointer(LIGHT_TEX_COORD_COMPONENT_SIZE, GL11.GL_SHORT, VERTEX_SIZE, LIGHT_TEXT_COORD_COMPONENT_OFFSET);
        OpenGlHelper.setClientActiveTexture(OpenGlHelper.defaultTexUnit);
